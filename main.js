...
function keyUpListener(e) {
	// increase framerate when "f" is released
	// decrease framerate when "s" is released
	if (e.keyCode == 70) { createjs.Ticker.framerate = fast; }
	if (e.keyCode == 83) { createjs.Ticker.framerate = slow; }
}
